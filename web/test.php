...
use classes\DependencyInjection\Extension;
...
class Kernel
{
    ...
    public function getContainerBuilder()
    {
        ...
        $container->getCompilerPassConfig()->setMergePass(new MergeExtensionConfigurationPass(['ok_app']));

        $c1 = $container->getCompiler();
